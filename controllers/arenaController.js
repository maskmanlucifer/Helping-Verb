...
module.exports.filter= async(req, res) => {
    ...
    const user = await User.find({batch: batch,status:true });
    res.render('arena_5',{data:user,arenaName:"Grand masters"});
